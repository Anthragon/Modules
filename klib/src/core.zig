...
pub const panic: PanicSig = switch (module_config.builtin) {
    true => @extern(PanicSig, .{ .name = "cap [00000000-0000-0000-0000-000000000000] PC System.ModuleHelper::panic" }),
    false => @extern(PanicSig, .{ .name = "cap [00000000-0000-0000-0000-000000000000] C System.ModuleHelper::panic" }),
};
...
pub const log_info: LogSig = switch (module_config.builtin) {
    true => @extern(LogSig, .{ .name = "cap [00000000-0000-0000-0000-000000000000] PC System.ModuleHelper::log_info" }),
    false => @extern(LogSig, .{ .name = "cap [00000000-0000-0000-0000-000000000000] C System.ModuleHelper::log_info" }),
};
pub const log_debug: LogSig = switch (module_config.builtin) {
    true => @extern(LogSig, .{ .name = "cap [00000000-0000-0000-0000-000000000000] PC System.ModuleHelper::log_debug" }),
    false => @extern(LogSig, .{ .name = "cap [00000000-0000-0000-0000-000000000000 C ]System.ModuleHelper::log_debug" }),
};
pub const log_warn: LogSig = switch (module_config.builtin) {
    true => @extern(LogSig, .{ .name = "cap [00000000-0000-0000-0000-000000000000] PC System.ModuleHelper::log_warn" }),
    false => @extern(LogSig, .{ .name = "cap [00000000-0000-0000-0000-000000000000] C System.ModuleHelper::log_warn" }),
};
pub const log_err: LogSig = switch (module_config.builtin) {
    true => @extern(LogSig, .{ .name = "cap [00000000-0000-0000-0000-000000000000] PC System.ModuleHelper::log_err" }),
    false => @extern(LogSig, .{ .name = "cap [00000000-0000-0000-0000-000000000000] C System.ModuleHelper::log_err" }),
};
pub const log_raw: LogSig = switch (module_config.builtin) {
    true => @extern(LogSig, .{ .name = "cap [00000000-0000-0000-0000-000000000000] PC System.ModuleHelper::log_raw" }),
    false => @extern(LogSig, .{ .name = "cap [00000000-0000-0000-0000-000000000000] C System.ModuleHelper::log_raw" }),
};
